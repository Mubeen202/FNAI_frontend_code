...
import LalligaResultsData from './LalligaResultsData'
import Colors from '../../../Utils/Colors';

export default function LaligaResults() {
const [matchData, setMatchData]=useState(LalligaResultsData)
useEffect(()=>{
  setMatchData(LalligaResultsData)
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <MatchCard
        ...
        team1Goals={item.team1Goals}
        team2Goals={item.team2Goals}
      />
    ))}
